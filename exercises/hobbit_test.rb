...
require './lib/hobbit'
# class b needs to have an attr accessor to read as well as overwrite class a. whichever has instance variable will need attr_accessor
class HobbitTest < Minitest::Test
  ...
  def test_hobbit_has_the_ring_if_its_name_is_frodo
    ...
    assert_equal false, samwise.has_ring?
  end
